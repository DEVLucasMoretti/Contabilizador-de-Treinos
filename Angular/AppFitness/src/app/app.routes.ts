...
import { IndexTreinos } from './pages/index-treinos/index-treinos';
...
[
  ...
  {path: 'treinos', component: IndexTreinos, canActivate: [AuthGuard], data: { permissao: 'Treino' }, title: 'Treino'},
